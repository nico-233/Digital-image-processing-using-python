...
class Cartoonizer:
    ...
    def render(self, img_rgb):
        ...
        cv2.imwrite("/Users/user/Downloads/landscape_edge.png",img_edge)
...
file_name = "/Users/user/Downloads/IMG_1848.jpg" #File_name will come here
res = tmp_canvas.render(file_name)
cv2.imwrite("/Users/user/Downloads/landscape_cartoon.jpg", res)
cv2.imshow("Cartoon version", res)
cv2.waitKey(100)
#blackimg = cv2.imread("/Users/user/Downloads/edge.png")
#dst = cv2.fastNlMeansDenoisingColored(blackimg, None, 120, 10, 7, 25)
#cv2.imwrite("/Users/user/Downloads/denoised.png", dst)
